...
class SnapshotToAlarmConfigMapper @Inject constructor() : IMapper<DocumentSnapshot, AlarmConfig> {
    ...
    override fun singleFromLeftToRight(left: DocumentSnapshot): AlarmConfig {
        return AlarmConfig(
            ...
            threshold = left.get("threshold", Int::class.java) ?: DEFAULT_ALARM_THRESHOLD
        )
    }
