 ...
 * */
open class UpdateAlarmConfigTimeUseCase @Inject constructor(
    private val configRepo: IAlarmConfigRepo,
    private val getAlarmConfigUseCase: GetAlarmConfigUseCase,
    @IoDispatcher ioDispatcher: CoroutineDispatcher,
    @MainDispatcher mainDispatcher: CoroutineDispatcher
) : UseCase<Unit, UpdateAlarmConfigTimeUseCase.Params>(ioDispatcher, mainDispatcher) {
    ...
    override suspend fun run(params: Params): Resource<Unit> {
        ...
        if (currentAlarm is Resource.Success) {
            ...
            return configRepo.setAlarmConfig(params.skycamKey, newTime, currentAlarm.value.isActive)
