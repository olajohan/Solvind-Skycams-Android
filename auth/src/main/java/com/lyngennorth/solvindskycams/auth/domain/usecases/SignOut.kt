...
class SignOut @Inject constructor(private val repo: IAuthenticatorRepo) : UseCase<Unit, UseCase.None>() {

    override suspend fun run(params: None): Either<Failure, Unit> = repo.signOut()
